    ...
    <div className='home'>
      ...
      <main>
        ...
        <section className={clsx(styles.cources)}>
          <h2 className={styles.headingLv2}>Luyện tập trắc nghiệm online tại learn4ever</h2>
          <p className={styles.desc}>Làm trắc nghiệm online các môn Toán, Lý, Hóa, Sinh, Sử, Địa, GDCD, Tiếng Anh, Văn với các bài luyện tập theo chương trình học và đề thi học kì, giữa kì, ... có đáp án, lời giải chi tiết.</p>
        </section>
      </main>
      <Footer />
    </div>
